...
import 'package:flutter256/data/db/entity/chat.dart';
import 'package:flutter256/data/db/remote/firebase_auth_source.dart';
import 'package:flutter256/data/db/remote/firebase_database_source.dart';
import 'package:flutter256/data/db/remote/firebase_storage_source.dart';
import 'package:flutter256/data/db/remote/response.dart';
import 'package:flutter256/data/model/chat_with_user.dart';
import 'package:flutter256/data/model/user_registration.dart';
import 'package:flutter256/util/shared_preferences_utils.dart';
import 'package:flutter256/data/db/entity/app_user.dart';
import 'package:flutter256/util/utils.dart';
import 'package:flutter256/data/db/entity/match.dart';
...
class UserProvider extends ChangeNotifier {
  ...
  Future<Response> registergoogleUser(
      GlobalKey<ScaffoldState> errorScaffoldKey) async {
